...
![](image-20210112212004137.png)

上境图：

![](image-20210112211354752.png)

共轭函数 $\displaystyle f^*(y)=\sup_{x\in \mathbf{dom}f}*(y^Tx-f(x))$：

![](image-20210112212840193.png)
...
![](image-20210112213224293.png)

也就是说：$f(\theta x+(1-\theta)y)\le \max\{f(x),f(y)\}$

![](image-20210112213332290.png)
...
![](image-20210112213408052.png)

3. 向量的零范数（非零元素的个数）

拟凸函数的二阶条件：

![](image-20210112213609724.png)
...
![](image-20210112213640429.png)

![](image-20210112213701936.png)
